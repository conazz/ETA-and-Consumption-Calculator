...
const CACHE_NAME = "eta-calculator-v13";
...
// and feels fast), while quietly fetching a fresh copy in the background for
// next time. Falls back to cache if the network is unavailable.
